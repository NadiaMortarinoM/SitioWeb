...
switch($accion){
    case"Agregar":
        ...
        //Inserto la información a la base de datos con los parámetros que pone el usuario.
...
//Para saber que la información se esta procesando:
    case"Modificar":
        ...
        if($txtImagen!=""){ //si hay imagen para adjuntar:
...
//ejecutar una instrucción SQL con el método Fetch All de la lista de libros:
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <img src="../../img/<?php echo $libro['imagen']; ?>" class="img-thumbnail rounded" width="50" alt="" srcset="">    
                </td>
